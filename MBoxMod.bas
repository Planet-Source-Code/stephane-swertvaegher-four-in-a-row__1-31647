...
mbT = 4
For xx = 0 To 12
MBox.Line (25 - NewStep, mbT + xx)-(MBox.ScaleWidth - 25 + NewStep, mbT + xx), RGB(NewR, NewG, NewB)
MBox.Line (25 - NewStep, mbT + 25 - xx)-(MBox.ScaleWidth - 25 + NewStep, mbT + 25 - xx), RGB(NewR, NewG, NewB)
